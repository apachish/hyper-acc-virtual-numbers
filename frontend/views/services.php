    ...
    <div class="rent-wrapper">
        ...
        <div class="rent-header">
                ...
                <a href="https://Hyper-acc.com/wallet" target="_blank" class="wallet-balance">
                    ...
                    <div class="balance-info">
                        ...
                        <span class="balance-amount"
                              id="wallet-balance"><?php echo number_format(get_user_meta(get_current_user_id(), 'havn_balance', true) ?: 0, 0); ?> تومان</span>
                    </div>
                </a>
            </div>
            ...
            <div class="search-box">
                ...
                <button class="clear-search" id="clear-search" style="display: none;"
                        onclick="document.getElementById('havn-services-search').value=''; document.getElementById('havn-services-search').focus(); if(typeof performSearch === 'function') performSearch();">
                    پاک کردن جستجو
                </button>
        ...
        <div class="purchase-modal" id="purchase-confirmation-modal" style="display: none;">
            ...
            <div class="purchase-modal-content">
                ...
                <div class="purchase-modal-footer">
                    ...
                    <button class="btn btn-primary" id="confirm-purchase-btn" onclick="confirmPurchase()">تأیید خرید
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="error-modal" id="error-modal" style="display: none;">
            ...
            <div class="error-modal-content">
                ...
                <div class="error-modal-footer" id="error-modal-footer">
...
<!--                            <option value="desc">زیاد به کم</option>-->
                ...
                <div class="rent-table" id="countries-table">
                    <div class="row">
                        <div class="col"
                             style="grid-column: 1 / -1; text-align: center; color: #FC5A44; padding: 40px 20px;">
            ...
            <div class="rent-table-box" id="purchases-section">
                <div class="rent-user">
                ...
                <div class="countries-container" id="countries-container">
                    <div class="row">
                        ...
                        <?php } else{ ?>
                        <div style="font-size: 16px; margin-bottom: 8px;">🧑‍💻</div>
                        برای دیدن شماره های خریداری شده از قبل، وارد اکانت خود شوید.
                    </div>
                    <?php } ?>
                </div>
            </div>
...
<div class="havn-mobile-bottom-nav" id="mobile-bottom-nav">
    <a class="bottom-nav-item active" data-section="services"  href="#services-section" onclick="handleBottomNavClick(event, this)">
        <div class="nav-icon"><i class="fa fa-mobile" aria-hidden="true"></i>
        </div>
        <div class="nav-label">سرویس‌ها</div>
    </a>
    <a class="bottom-nav-item" data-section="countries" href="#countries-table" onclick="handleBottomNavClick(event, this)">
        <i class="fa fa-server" aria-hidden="true"></i>
        <div class="nav-label">کشورها</div>
    </a>
    <a class="bottom-nav-item" data-section="purchases" href="#purchases-section" onclick="handleBottomNavClick(event, this)">
        <i class="fa fa-shopping-cart" aria-hidden="true"></i>
        <div class="nav-label">خریدها</div>
    </a>
</div>
    ...
    if (originalLoadServiceCountries) {
        window.loadServiceCountries = function (serviceId) {
            ...
            fetch(havn_ajax.ajax_url, {method: 'POST', body: formData})
                ...
                .then(({resp, json}) => {
                    if (havnHandleUnauthorized(resp, json)) {
                        return;
                    }
